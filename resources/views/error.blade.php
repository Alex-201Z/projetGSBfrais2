...
@section('content')
    <div class="alert alert-danger" role="alert">
        <p>Désole une erreur technique empèche le bon fonctionnement du site !</p>
       @if (is_a($exception,"App\Exceptions\UserException")) <p>{{ $exception->getUserMessage() }}</p>@endif
